...
contract PriceOracle {
    ...
    function getPrice(uint lat, uint lon) public {
    ...
    function updatePrice(uint temp, uint _jobId)public {
        //when update Price is called by node.js upon API results, data is updated
